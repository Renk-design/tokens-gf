...
var exprEvalFork = require('expr-eval-fork');
var postcssCalcAstParser = require('postcss-calc-ast-parser');

const mathChars = ['+', '-', '*', '/'];
const parser = new exprEvalFork.Parser();
...
function parseAndReduce(expr) {
    ...
    const calcParsed = postcssCalcAstParser.parse(noPixExpr, { allowInlineCommnets: false });
