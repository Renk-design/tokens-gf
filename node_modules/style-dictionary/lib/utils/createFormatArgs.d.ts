 ...
 */
export default function createFormatArgs({ dictionary, platform, options, file }: FormatFnArguments): import("../../types/Format.ts").FormatFnArguments & import("../../types/DesignToken.js").Dictionary;
